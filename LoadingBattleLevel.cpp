...
void LoadingBattleLevel::update(float dt, const ControlState &controlState) {
...
LoadingBattleLevel::LoadingBattleLevel() : knifeSlashSound(nullptr), knifeEntity("res/anim/knifeslash1.png", 7, 130) {
